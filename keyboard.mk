...
# Board id passed to `west build -b`. This branch builds against the new ZMK
# hardware-model target, while the artifact is still named nice_nano_v2.
BUILD_BOARD  ?= nice_nano@2//zmk
