...
```bash
INIT=$(node "/Users/sddenny05/Documents/Charybdis Mini ZMK Firmware/.claude/get-shit-done/bin/gsd-tools.cjs" init quick "$DESCRIPTION")
...
```bash
node "/Users/sddenny05/Documents/Charybdis Mini ZMK Firmware/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs(quick-${quick_id}): ${DESCRIPTION}" --files ${file_list}
```
